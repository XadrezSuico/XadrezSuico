...
@section("title", "Visualizar Indicados - Evento: ".$evento->name)

@section('content_header')
  <h1>Visualizar Indicados</h1>
  <h4>Evento: {{$evento->id}} - {{$evento->name}}</h4>
  <h4>Campo: {{$opcao->campo->public_name}}</h4>
  <h4>Opção: {{$opcao->response}}</h4>
@stop
...
<div class="row">
  ...
  <section class="col-lg-12 connectedSortable">
	...
	<div class="box box-primary">
		<div class="box-header">
			<h3 class="box-title">Lista de Indicados</h3>
			<div class="pull-right box-tools">
			</div>
		</div>
