            ...
            @foreach($inscricoes as $inscricao)
                ...
                <tr>
                    ...
                    <td colspan="2" style="TEXT-ALIGN: CENTER">
                        @if($fill_blanks) @if($inscricao->confirmado) @if($inscricao->hasConfig("team_order")) {{ $inscricao->getConfig("team_order",true) > 0 ? $inscricao->getConfig("team_order",true) : null}} @else CON @endif @endif @endif
                    </td>
                </tr>
            @endforeach
        @endforeach
