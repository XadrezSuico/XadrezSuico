...
@section("title", "Evento #".$evento->id." (".$evento->name.") >> Classificador >> Vínculo de Categorias >> Editar")
@section('content_header')
  <h1>Evento #{{$evento->id}} ({{$evento->name}}) >> Classificador >> Vínculo de Categorias >> Editar</h1>
@stop
