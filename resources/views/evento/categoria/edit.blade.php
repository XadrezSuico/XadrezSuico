...
@section("content")
  ...
  <section class="col-lg-6 connectedSortable">
		...
		<div class="box box-primary">
			...
			<!-- form start -->
			<form method="post" action="{{url("/evento/".$evento->id."/categorias/".$categoria->id."/sexo/add")}}">
				<div class="box-body">
					<div class="form-group">
						...
						<tbody>
							@foreach($categoria->sexos()->orderBy("sexos_id","ASC")->get() as $sexo)
								<tr>
									...
									<td>
										<a class="btn btn-danger" href="{{url("/evento/".$evento->id."/categorias/".$categoria->id."/sexo/remove/".$sexo->id)}}" role="button"><i class="fa fa-times"></i></a>
									</td>
								</tr>
							@endforeach
						</tbody>
