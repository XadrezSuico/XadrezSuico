...
<div class="v2-timeline-tab">
    <p class="text-muted v2-timeline-tab__intro">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <ul class="list-unstyled v2-timeline-auto-list">
    ...
    <div class="row v2-timeline-panels">
        @if($can_edit)
        ...
        <section class="col-lg-{{ $can_edit ? '8' : '12' }} connectedSortable">
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive no-padding">
                    @if($items->count() === 0)
                        <p class="text-muted v2-timeline-empty">Nenhum item adicional cadastrado.</p>
                    @else
