...
class TipoRatingController extends Controller
{
    ...
    public function regra_add($id,Request $request){
        ...
        if($request->has("idade_minima")) if($request->input("idade_minima") != NULL) $tipo_rating_regra->idade_minima = $request->input("idade_minima");
        if($request->has("idade_maxima")) if($request->input("idade_maxima") != NULL) $tipo_rating_regra->idade_maxima = $request->input("idade_maxima");
