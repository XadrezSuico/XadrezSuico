...
class Torneio extends Model
{
    ...
    {
        $torneio = $this;
        if ($this->evento->criterios()->where([["tipo_torneio_id", "=", $this->tipo_torneio_id],["softwares_id","=",$this->software->id],["torneio_id","=",$this->torneio_id]])->count() > 0) {
            Log::debug($this->evento->criterios()->where([["tipo_torneio_id", "=", $this->tipo_torneio_id],["softwares_id","=",$this->software->id],["torneio_id","=",$this->torneio_id]])->whereDoesntHave("criterio", function ($q1) use ($torneio) {
                $q1->where([
                    ["is_manual", "=", true],
                ]);
            })->count());
            return $this->evento->criterios()->where([["tipo_torneio_id", "=", $this->tipo_torneio_id],["softwares_id","=",$this->software->id],["torneio_id","=",$this->torneio_id]])->whereDoesntHave("criterio", function ($q1) use ($torneio) {
                $q1->where([
                    ["is_manual", "=", true],
                ]);
            })->count();
        ...
        return $this->evento->grupo_evento->criterios()->where([["tipo_torneio_id", "=", $this->tipo_torneio_id],["softwares_id","=",$this->software->id],["torneio_id","=",$this->torneio_id]])->whereDoesntHave("criterio", function ($q1) use ($torneio) {
            $q1->where([
                ["is_manual", "=", true],
            ]);
        })->count();
