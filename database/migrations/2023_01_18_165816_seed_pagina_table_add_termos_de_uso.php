...
class SeedPaginaTableAddTermosDeUso extends Migration
{
    ...
    public function up()
    {
        ...
        $pagina->title = "Termos de Uso do ".config("xadrezsuico.name");
        $pagina->texto = "<h3>A. Condições Gerais</h3>
            <p>Este documento contém os Termos de Uso da plataforma de gerenciamento de Circuito de Xadrez ". config("xadrezsuico.name","XadrezSuíço"). ", cuja aceitação plena e integral requisito
            ...
            <p> A plataforma  " . config("xadrezsuico.name", "XadrezSuíço") . " é uma plataforma virtual de gerenciamento de Circuitos de Xadrez, que atua no pré e pós-evento. No pré-evento atua com
