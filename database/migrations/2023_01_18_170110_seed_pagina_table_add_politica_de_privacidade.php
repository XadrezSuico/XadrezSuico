...
class SeedPaginaTableAddPoliticaDePrivacidade extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(Pagina::where([["uuid","=","16f32fa4-c9f8-43ca-bc41-b7ceac03b60e"]])->count() > 0){
            $pagina = Pagina::where([["uuid","=","16f32fa4-c9f8-43ca-bc41-b7ceac03b60e"]])->first();
        }else{
            $pagina = new Pagina;
